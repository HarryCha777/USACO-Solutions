...
#include <cstring> // no need
#include <algorithm>
#include <vector>
#include <cassert> // no need
#include <fstream>
#include <map>
#include <set>
#include <string>
#include <cmath> // no need but may be useful
...
int main() {
	...
	for (int u = N - 1; u >= 0; u--) {
		...
		// Compute assigned_dp[S] for all of the interesting states S computed above.
	...
	return 0; // never forget to set up as STARTUP Project
}